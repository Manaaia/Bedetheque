                ...
                <div>
                    ...
                    <div>
                        ...
                        <p class="identite">
                            ...
                            <input type="text" class = "lettre" id="nomadherent" name="nomAdherent" placeholder="Veuillez renseigner un nom" value="<?php echo $nomAdherent ?>" required><br/>
                            <label for="prenomadherent">Prénom (*)</label><br/>
                            <input type="text" class = "lettre" id="prenomadherent" name="prenomAdherent" placeholder="Veuillez renseigner un prénom" value="<?php echo $prenomAdherent ?>" required>
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p><input type="date" id="datecot" name="dateCo" value="<?php echo $dateCo ?>" required></p>
                    </div>
